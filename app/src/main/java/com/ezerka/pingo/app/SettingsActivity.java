...
public class SettingsActivity extends AppCompatActivity implements
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    setContentView(com.ezerka.pingo.R.layout.activity_settings);
    Log.d(TAG, "onCreate: started.");
    mEmail = (EditText) findViewById(com.ezerka.pingo.R.id.input_email);
    mCurrentPassword = (EditText) findViewById(com.ezerka.pingo.R.id.input_password);
    mSave = (Button) findViewById(com.ezerka.pingo.R.id.btn_save);
    mProgressBar = (ProgressBar) findViewById(com.ezerka.pingo.R.id.progressBar);
    mResetPasswordLink = (TextView) findViewById(com.ezerka.pingo.R.id.change_password);
    mName = (EditText) findViewById(com.ezerka.pingo.R.id.input_name);
    mPhone = (EditText) findViewById(com.ezerka.pingo.R.id.input_phone);
    mProfileImage = (ImageView) findViewById(com.ezerka.pingo.R.id.profile_image);
    ...
    mSave.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        if (!mName.getText().toString().equals("")) {
          reference.child(getString(com.ezerka.pingo.R.string.dbnode_users))
            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
            .child(getString(com.ezerka.pingo.R.string.field_name))
        ...
        if (!mPhone.getText().toString().equals("")) {
          reference.child(getString(com.ezerka.pingo.R.string.dbnode_users))
            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
            .child(getString(com.ezerka.pingo.R.string.field_phone))
    ...
    mProfileImage.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        if (mStoragePermissions) {
          ...
          dialog.show(getSupportFragmentManager(), getString(com.ezerka.pingo.R.string.dialog_change_photo));
        } else{
          verifyStoragePermissions();
        }
...
//                    Toast.makeText(SettingsActivity.this, "Upload Success", Toast.LENGTH_SHORT).show();
          ...
          FirebaseDatabase.getInstance().getReference()
            .child(getString(com.ezerka.pingo.R.string.dbnode_users))
            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
            .child(getString(com.ezerka.pingo.R.string.field_profile_image))
  ...
  private void getUserAccountData() {
    ...
    DatabaseReference reference = FirebaseDatabase.getInstance().getReference();
        ...
        /*
            ---------- QUERY Method 1 ----------
         */
    Query query1 = reference.child(getString(com.ezerka.pingo.R.string.dbnode_users))
      .orderByKey()
    ...
    query1.addListenerForSingleValueEvent(new ValueEventListener() {
      ...
      public void onCancelled(DatabaseError databaseError) {
        ...
        /*
            ---------- QUERY Method 2 ----------
         */
    Query query2 = reference.child(getString(com.ezerka.pingo.R.string.dbnode_users))
      .orderByChild(getString(com.ezerka.pingo.R.string.field_user_id))
      .equalTo(FirebaseAuth.getInstance().getCurrentUser().getUid());
